...
class Soglie:
    ...
    PORTE_DNS = {53} 
    # Porte infrastrutturali di rete, Dominio/Active Directory e Broadcast LAN
    PORTE_INFRASTRUTTURA_LAN = {
        53,    # DNS
        88,    # Kerberos
        123,   # NTP
    ...
    SCAN_DESTINAZIONI_MAX_PER_CONCENTRAZIONE = 3
    ...
    PORTE_SORGENTE_UNICHE_MIN = 100
    FLUSSI_HIGH_RATE_MIN = 3   # almeno 3 flussi sopra soglia PPS, non un singolo outlier
    DOS_GOLDENEYE_RPS_MIN = 5.0   # sotto questa soglia è brute force lento, non un vero flood
    RATIO_PORTE_EFFIMERE_ESTREMA = 0.90
    ...
    WEB_SCORE_MIN_FOR_PRIORITY = 0.70
