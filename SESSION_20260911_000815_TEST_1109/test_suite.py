...
async def run_benchmark():
    ...
    try:
        for idx, sc in enumerate(scenari, start=1):
            ...
            try:
                log_mcp_str = ""
                # Esecuzione analisi direct-LLM (ora restituisce un dizionario)
                ...
                # Estrazione dati dal dizionario ritornato
                ...
                # Integrato lo stato investigativo nella telemetria
