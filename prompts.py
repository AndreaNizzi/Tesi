...
- CONTRO-EVIDENZE VALIDE PER BENIGN:
  ...
  * payload_entropy = 0 (flag binario: nessun segnale di entropia anomala rilevato)
    ED esplicita destinazione verso domini/hostname reputati o in Whitelist (es. CDN, Google,
    Cloudflare, servizi di aggiornamento OS/Antivirus).
...
2. PRIORITÀ 2 - EXPLOIT WEB/L7: se sono presenti exploit web conclamati
   (pattern compatibili con SQLi, XSS, Path Traversal), payload_entropy=1
   su richieste HTTP anomale, o Web Brute Force a basso volume (< 150 flussi) -> VERDETTO =
   WEB_ATTACK_EXPLOIT.
