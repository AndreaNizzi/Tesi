        ...
        for res in risultati_tool_raccolti:
            if isinstance(res, dict) and res.get("tool_name") == "compute_verdict_scores":
                ...
                if isinstance(data_out, dict):
                    ...
                    # FIX: usa il verdetto già risolto dal tie-break di _calcola_scores_da_evidenze
                    # (verdetto_suggerito_euristica) invece di ricalcolare il max qui, che su un
                    # pareggio sceglierebbe sempre il primo elemento del dizionario (DOS_VOLUMETRIC)
                    # a prescindere da quale evidenza grezza il tie-break abbia davvero preferito.
                    ...
                    if verdetto_dal_tool in verdetti_validi_locali:
                        ...
                        # fallback quando il tool restituisce CONFLITTO_IRRISOLTO o un valore mancante
